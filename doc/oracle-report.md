...
|---|---|---|---|
| 1 | no public accessor (API-wide) | shape — H5Attribute exposes no shape() accessor | 8 (attr_scalar_num, attr_array_num, attr_string, attrs_dense…) |
...
| 6 | no public accessor (API-wide) | attrstore — H5NamedDatatype exposes no compact/dense attribute storage accessor | 3 (named_datatype, sohm_list, sohm_btree) |
