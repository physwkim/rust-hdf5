...
Generated by `oracle/run.py` against libhdf5 1.14.6 / h5py 3.15.1. 82 cases.
...
|---|---|---|---|---|---|
| `superblock-always-v3` | `superblock` | `*` | `3` | yes | 43 (int_i8, int_u8, int_i16le…) |
...
| API cannot express | no rust writer arm: the public API cannot express this case | 23 |  |
| no public accessor (API-wide) | attrorder — H5Group exposes no attribute creation-order tracking flags | 81 | /#attrorder |
| no public accessor (API-wide) | linkorder — H5Group exposes no link creation-order tracking flags | 81 | /#linkorder |
